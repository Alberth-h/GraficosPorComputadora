...
def checar_colisiones():
    ...
    if carrito.posx + 0.05 > xObstaculo - 0.15 and carrito.posx - 0.05 < xObstaculo + 0.15 and carrito.posy + 0.05 > yObstaculo - 0.15 and carrito.posy - 0.05 < yObstaculo + 0.15:
